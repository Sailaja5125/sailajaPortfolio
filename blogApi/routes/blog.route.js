...
router.route('/createBlog').post(upload.single('thumbnail'), createblog);
...
router.route('/editblog/:id').post(upload.single('thumbnail'), editBlog) // - PATCH/6657c3f4a1b2c9e123456789
